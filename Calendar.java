...
//  if(i%2 == 0)
 // System.out.print("\t");
  printCalenderBody(i,year);
  }
 }
 public static void printCalenderBody(int month,int year){
   String monthTitel = getMonthTitel(month);
   System.out.printf("\n%16s,%-2d\n",monthTitel,year);
   System.out.println("-----------------------------");
   for(int i = 0 ; i < 7 ; i++)
    System.out.printf("%4s",getWeekTitel(i));
    System.out.println();
    int startDay = startDayOfMonth(month,year);
